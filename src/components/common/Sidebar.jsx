...
const SIDEBAR_ITEMS = [
	{ name: "Alerts", icon: ShoppingBag, color: "#8B5CF6", href: "/alerts" },
...
const Sidebar = () => {
	...
	return (
		...
		>
			<div className='h-full bg-white bg-opacity-90 backdrop-blur-md p-4 flex flex-col border-r border-gray-300'>
				<motion.button
